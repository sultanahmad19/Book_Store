...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="update_name" value="<?php echo $fetch_update['name']; ?>" class="box" placeholder="enter product name" required>
        
    <input type="number" name="update_price" value="<?php echo $fetch_update['price']; ?>" min="0" class="box" placeholder="enter product price" required>
    ...
    <!-- custom admin js  -->
    <script src="js/admin-script1.js "></script>
</body>
</html>